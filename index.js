...
const slashCommands = [
  ...
  new SlashCommandBuilder().setName('givecoins').setDescription('Owner: Give coins').addUserOption(o => o.setName('user').setRequired(true)).addIntegerOption(o => o.setName('amount').setRequired(true).setMinValue(1)),
  new SlashCommandBuilder().setName('takecoins').setDescription('Owner: Take coins').addUserOption(o => o.setName('user').setRequired(true)).addIntegerOption(o => o.setName('amount').setRequired(true).setMinValue(1)),
  new SlashCommandBuilder().setName('setxp').setDescription('Owner: Set XP').addUserOption(o => o.setName('user').setRequired(true)).addIntegerOption(o => o.setName('amount').setRequired(true).setMinValue(0)),
  new SlashCommandBuilder().setName('addxp').setDescription('Owner: Add XP').addUserOption(o => o.setName('user').setRequired(true)).addIntegerOption(o => o.setName('amount').setRequired(true).setMinValue(1)),
  new SlashCommandBuilder().setName('setlevel').setDescription('Owner: Set level').addUserOption(o => o.setName('user').setRequired(true)).addIntegerOption(o => o.setName('level').setRequired(true).setMinValue(0)),
  new SlashCommandBuilder().setName('takelvl').setDescription('Owner: Remove levels').addUserOption(o => o.setName('user').setRequired(true)).addIntegerOption(o => o.setName('levels').setRequired(true).setMinValue(1)),
  new SlashCommandBuilder().setName('resetuser').setDescription('Owner: Reset profile').addUserOption(o => o.setName('user').setRequired(true)),
  new SlashCommandBuilder().setName('setbump').setDescription('Owner: Set bump channel').addChannelOption(o => o.setName('channel').setRequired(true)),
  new SlashCommandBuilder().setName('setbumpinterval').setDescription('Owner: Set bump interval').addIntegerOption(o => o.setName('hours').setMinValue(0).setMaxValue(24)).addIntegerOption(o => o.setName('minutes').setMinValue(0).setMaxValue(59)),
].map(cmd => cmd.toJSON());
